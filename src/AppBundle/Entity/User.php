...
class User
{
     ...
     * @var bool
     *
     * @ORM\Column(name="isACertificatPilot", type="boolean")
     */
    private $isACertificatPilot;
    ...
    /**
     * Set isACertificatPilot
     *
     * @param boolean $isACertificatPilot
     *
     * @return User
     */
    public function setIsACertificatPilot($isACertificatPilot)
    {
        $this->isACertificatPilot = $isACertificatPilot;

        return $this;
    }

    /**
     * Get isACertificatPilot
     *
     * @return bool
     */
    public function getIsACertificatPilot()
    {
        return $this->isACertificatPilot;
    }
    /**
     * Constructor
     */
     ...
     * Add passenger
     *
     * @param \AppBundle\Entity\Review $passenger
     *
     * @return User
     */
    public function addPassenger(\AppBundle\Entity\Review $passenger)
    {
     ...
     * @param \AppBundle\Entity\Review $passenger
     */
    public function removePassenger(\AppBundle\Entity\Review $passenger)
    {
